...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM" URI="http://resources/4.1.12/app/PWM/0" description="Generates a PWM using one timer slice of CCU4 or CCU8" mode="NOTSHARABLE" version="4.1.12" minDaveVersion="4.3.2" instanceLabel="TRIGGER_IN" appLabel="" containingProxySignal="true">
  ...
  <hwResources name="PWM Output Pin" URI="http://resources/4.1.12/app/PWM/0/__pin_hwres_port_pad_pwm_out" resourceGroupUri="devicepackage/0/15" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
